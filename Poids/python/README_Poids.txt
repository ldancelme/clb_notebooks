...
- mean_method.py : Détection des outliers : Pour chaque point, cherche la moyenne des mois suivant et mois précédent 
et calcule le % d'écart dans le poids.
...
- MAD.py : Script explorant la méthode de Median Absolute Deviation pour repérer les outliers
...
- README_Taille.md : Version Mardown de ce README

- slope_method.py : Détection des outliers : Calcul de la pente entre chaque points. 
Utilisation d'une valeur limite de pente pour détecter les points qui dérivent trop du reste des autres.
