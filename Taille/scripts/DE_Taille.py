...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 18 17:14:09 2020
...
taille = pd.read_csv("Projet IMC v2.csv")
# , dtype={'IPPR' : str, 'Nom' : str, 'Age_patient_à_la_saisie_de_la_taille' : str, 'Nb_jours_entre_diag_et_saisie_de_la_taille' : str, 'Taille' : str, 'Appli_origine' : str}
